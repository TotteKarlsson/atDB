...
insert  into `block`(`id`,`created`,`created_by`,`modified`,`status`,`label`,`process_id`) values 
(19,'2016-10-18 09:42:18',27,'2016-10-18 09:42:18',0,'XXXXXX',31);
...
(663,'Image Note..','2016-10-17 17:25:17',7);
...
CREATE TABLE `specimen` (
  ...
  `species` smallint(11) DEFAULT NULL,
  ...
  CONSTRAINT `specimen_ibfk_10` FOREIGN KEY (`species`) REFERENCES `species` (`id`),
...
(31,'081015a',1,'Human Surgical','',NULL,'1900-01-01',0,1,0,'LTC',6,'1900-01-01','2016-02-06',0,5,0,0,2),
(32,'081015a',1,'Human Surgical','',NULL,'1900-01-01',0,1,0,'LTC',6,'2016-02-04','2016-02-06',0,0,6,1,1),
...
(49,'233604',2,'WT (C57BL/6)','',233604,'2016-05-18',0,2,2,'v1',4,'2016-05-18','2016-05-24',3,6,3,0,4),
...
(77,'H16.03.007',3,'full titer','',-1,'1900-01-01',3,2,0,'',4,'1900-01-01','2016-09-13',3,4,3,2,4),
(78,'H16.03.007',1,'1:10 dilution','',-1,NULL,6,2,0,'',4,'1900-01-01','2016-09-13',3,4,3,2,4),
(80,'TEST',NULL,NULL,NULL,NULL,'1900-01-01',0,0,0,NULL,NULL,'1900-01-01','1900-01-01',0,0,0,0,0);
