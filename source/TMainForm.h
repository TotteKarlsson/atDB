...
class TMainForm : public TRegistryForm
{
    ...
    private:
		...
		string                                          mTempFileFolder;
                                                        ...
                                                        //INI Parameters...
        dsl_shared_ptr<IniFileProperties>               mGeneralProperties;
        ...
        dsl_shared_ptr<IniFileProperties>                   mCoverslipPrintingProperties;
        dsl_shared_ptr<TRegistryProperties>                 mSplashProperties;
